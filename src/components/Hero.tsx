...
export function Hero() {
    ...
    return (
        <div className='relative h-screen w-full bg-black overflow-hidden'>
            ...
            <div className='absolute inset-0 flex flex-row'>
                ...
                <div className='relative w-1/2 h-full'>
                    <div
                        ...
                        style={{
                            backgroundImage:
                                'url("https://myquark-image-label.s3.ap-northeast-2.amazonaws.com/boltlab/heartsolo/KakaoTalk_Photo_2025-01-01-19-34-21+003.jpeg")',
                        }}
                    >
                ...
                <div className='relative w-1/2 h-full'>
                    <div
                        ...
                        style={{
                            backgroundImage:
                                'url("https://myquark-image-label.s3.ap-northeast-2.amazonaws.com/boltlab/heartsolo/KakaoTalk_Photo_2025-01-01-19-34-21+002.jpeg")',
                        }}
                    >
            ...
            <ReservationModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} onSubmit={handleReservation} />
        </div>
    );
}
